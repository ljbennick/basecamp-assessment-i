...
//;alskdja;lkfj 
var trueFaveNum = faveNum === 5;// CODE HERE
...
var notHakeem = myName !== "Hakeem Alajuwon";// CODE HERE
...
var responseCreator = function(param){
  ...
  colorResponse = "What's your favorite color?";
}
}
...
function greeter(name, number){
  return "Hi my name is " && name && " and I am " && number && " years old";
}
greeter(Jaxon, 21); //CODE HERE
